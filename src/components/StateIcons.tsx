// US state silhouettes. Path data from coryetzkorn/state-svg-defs (MIT).
// Fill follows currentColor; size via className (e.g. "h-10 w-auto text-brand").
type StateIconProps = { className?: string };

export function KentuckyIcon({ className }: StateIconProps) {
  return (
    <svg viewBox="0 0 93 80" fill="currentColor" aria-hidden="true" className={className}>
...
export function TennesseeIcon({ className }: StateIconProps) {
  return (
    <svg viewBox="0 0 104 80" fill="currentColor" aria-hidden="true" className={className}>
