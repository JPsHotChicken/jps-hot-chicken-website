...
import { listRuleSignatures } from "@/lib/staff-rules-repo";
...
export default async function StaffPage() {
  ...
  const [publishedWeeks, requests, scheduledDates, payStubs, tipRates, ruleSignatures] =
    await Promise.all([
      ...
      listRuleSignatures(employee.id),
    ]);
